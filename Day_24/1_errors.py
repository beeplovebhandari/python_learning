...
# This type of error occurs when you mess up with grammar of the language
# For example : making typo in keywords, messing up with indentations, whitespace at unwanted places etc..
...
# These are all the errors except syntax error. They can furtherbe classified in followings;
1. TypeError
2. ValueError
...
# It is raised if we try to convert a datatype to another datatype which in not possible
...
# print(student["phone"]) #KeyError becaues phone is not present in dictionary 
...
# import mat  #ModuleNotFoundError becaues "mat" is not a valid package 