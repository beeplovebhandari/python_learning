...
# Major Features of Object Oriented Program;
# 1. Inheritance
# 2. Encapsulation
# 3. Polymorphism
# 4. Abstraction
...
print(Vehicle.category) # get_data #car
print(v1.category) # bike
...
# function inside a class is called the method of that class and that can be called with the object only 
